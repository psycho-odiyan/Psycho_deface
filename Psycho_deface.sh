...
clear
echo '[+] Author : P5YCH0_0D1Y4N'
echo '[+] Team   : CIA'
echo '[+] Github : https://github.com/psycho-odiyan'
echo ''
echo ''
...
<link rel="preload" href="https://adservice.google.co.id/adsid/integrator.js?domain=" as="script">
<script type="text/javascript" src="https://adservice.google.co.id/adsid/integrator.js?domain=">
</script><link rel="preload" href="https://adservice.google.com/adsid/integrator.js?domain=" as="script">
...
<meta content="" name="Abstract"><meta name="">
...
<script type="text/javascript" src="js/jquery-1.10.2.min.js.download">
</script> 
...
<iframe width="0" height="0" src="https://l.top4top.io/m_1515g8uyu0.mp3" frameborder="0" allowfullscreen="">
</iframe>
...
<blink> <center><br><font size="4" <font="" color="white">
<b>HACKED BY<br>
<br>
</b>
<span class="blink_me">
<font size="3" color="red" face="Wallpoet" style="text-shadow: 5px 0px 30px red;"> CYBER INTTELIGENS AGENCY </font>
</span>
</font>
</center>
<font size="4" <font="" color="white">
<br>
<center><font size="1" color="grey" face="Iceberg">"DON'T FOLLOW </font><font size="1" color="white" face="Iceberg">AM INDIAN HACKER" </font> 
<font size="1" color="grey" face="Iceberg"> 
<span style="color:white;" id="12">
</span>
</font>
</center> 
<b>
<b>
<div id="particles-js">	
<canvas class="particles-js-canvas-el" style="width: 100%; height: 100%;" width="1365" height="949">
</canvas>
</div> <!--<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/particles.js/2.0.0/particles.min.js">
</script>--> 
...
<font color="white">_____________________________________________________</font> 
</marquee>
</font>
<br>
<br>
<center>
<img src="https://2.bp.blogspot.com/-sPqnfxbA2b0/VOE_3Nt1UaI/AAAAAAAAEyY/radchk0H1dY/s1600/gambar-keren-wallpaper-tengkorak-bergerak-gif.gif" border="0" width="100px" height="100px">
<center><font color="white" size="1">Copyright@CYBER INTTELIGENS AGENCY</font>
</center>
</center>
</b>
</blink>
